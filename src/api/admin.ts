...
export const adminAPI = {
  ...
  getBehaviorAnalyticsOverview: (params?: Record<string, unknown>) => api.get('/admin/behavior-analytics/overview', { params }),
  getBehaviorAnalyticsSessions: (params?: Record<string, unknown>) => api.get('/admin/behavior-analytics/sessions', { params }),
  getBehaviorAnalyticsSession: (sessionId: string) => api.get(`/admin/behavior-analytics/sessions/${encodeURIComponent(sessionId)}`),
